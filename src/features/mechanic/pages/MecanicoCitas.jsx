...
const MecanicoCitas = () => {
  ...
  const fetchCitas = async () => {
    try {
      setLoading(true)
      const response = await makeRequest("/citas/mecanico/mis-citas")
  ...
  const filteredCitas = citas.filter((cita) => {
    ...
    const matchesDate = new Date(cita.fecha).toISOString().split("T")[0] === dateFilter
        ...
        <div className="dashC-header">
          <div className="dashC-header-content">
            ...
            <div className="dashC-title-container">
              <h1 className="dashC-title">Mis Citas Asignadas</h1>
            </div>
          </div>
        </div>
    ...
    <div className="dashC-body">
      ...
      <div className="dashC-Section1">
        <div className="lcc-filters">
          <div className="lcc-filter-group">
        ...
        <div className="dashC-content">
          {filteredCitas.length > 0 ? (
            ...
            <div className="lcc-empty-state">
              <FaCalendarAlt />
              <p>No tienes citas asignadas para los filtros seleccionados.</p>
            </div>
          )}
        </div>
      </div>
