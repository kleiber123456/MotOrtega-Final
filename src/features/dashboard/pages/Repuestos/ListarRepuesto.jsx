          ...
          <div className="listarRepuesto-pagination">
            ...
            {(() => {
              ...
              if (totalPaginas <= maxVisiblePages) {
                ...
                for (let i = 1; i <= totalPaginas; i++) {
                  pages.push(
                    <button
                      ...
                      className={`listarRepuesto-pagination-button ${paginaActual === i ? "active" : ""}`}
                    >
                      {i}
                    </button>,
                  )
                ...
                if (startPage > 1) {
                  pages.push(
                    <button key={1} onClick={() => setPaginaActual(1)} className="listarRepuesto-pagination-button">
                      1
                    </button>,
                  )
                  if (startPage > 2) {
                    pages.push(
                      <span key="ellipsis1" className="listarRepuesto-pagination-ellipsis">
                        ...
                      </span>,
                    )
                  }
                ...
                if (endPage < totalPaginas) {
                  if (endPage < totalPaginas - 1) {
                    pages.push(
                      <span key="ellipsis2" className="listarRepuesto-pagination-ellipsis">
                        ...
                      </span>,
                    )
                  }
