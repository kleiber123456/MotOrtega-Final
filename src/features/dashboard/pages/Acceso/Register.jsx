...
function Register() {
  ...
  // Prevenir el desplazamiento en la página
  useEffect(() => {
    ...
    <div className="register-progress-container" data-step={step}>
      {["Datos Personales", "Información de Contacto", "Seguridad"].map((label, index) => (
        <div key={index} className="register-progress-step">
          <div
            className={`register-progress-indicator ${step > index ? "register-progress-completed" : ""}`}
          >
            {index + 1}
          </div>
                      ...
                      {step === 1 && (
                        <>
                          <div className="register-section-title">
                            <i className="fas fa-user-circle"></i> Datos Personales
                          </div>
                          <input 
                            type="text" 
                    ...
                    <div className="register-buttons-container">
                      ...
                      {step < totalSteps ? (
                        ...
                        <button 
                          ...
                          disabled={formData.confirmPassword && !passwordMatch}
                        >
