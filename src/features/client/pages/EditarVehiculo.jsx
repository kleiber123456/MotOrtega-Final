...
import { FaCar, FaArrowLeft, FaCheck, FaExclamationTriangle, FaInfoCircle, FaSpinner } from "react-icons/fa"
import Swal from "sweetalert2"
import "../../../shared/styles/Client/CrearVehiculo.css" // Usando los mismos estilos que CrearVehiculo
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        const [vehiculoResponse, referenciasResponse] = await Promise.all([
          makeRequest(`/vehiculos/cliente/detalle/${id}`),
        ...
        await Swal.fire({
          ...
          text: error.message || "No se pudo cargar la información del vehículo.",
  ...
  const handleInputChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      if (name === "tipo_vehiculo") {
        newState.referencia_id = "" // Resetear referencia cuando cambia el tipo
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        icon: "error",
        title: "Error",
        text: error.message || "Error al actualizar el vehículo. Por favor intenta nuevamente.",
        confirmButtonColor: "#ef4444",
      })
    } finally {
      setLoading(false)
        ...
        <div className="cvc-crear-header">
          <div className="cvc-crear-header-content">
            ...
            <div className="cvc-crear-title-section">
              <h1 className="cvc-crear-page-title">Editar Vehículo</h1>
            </div>
          </div>
        </div>
      ...
      <div className="cvc-crear-container">
        <div className="cvc-crear-header">
          <div className="cvc-crear-header-content">
            ...
            <div className="cvc-crear-title-section">
              <h1 className="cvc-crear-page-title">Vehículo no encontrado</h1>
            </div>
          </div>
    ...
    <div className="cvc-crear-container">
      <div className="cvc-crear-header">
        <div className="cvc-crear-header-content">
          ...
          <div className="cvc-crear-title-section">
            <h1 className="cvc-crear-page-title">Editar Vehículo</h1>
            <p className="cvc-crear-subtitle">
      ...
      <div className="cvc-crear-content">
        <form onSubmit={handleSubmit} className="cvc-crear-main-card">
          <div className="cvc-crear-form-section">
            ...
            <div className="cvc-crear-form-grid">
              ...
              <div className="cvc-crear-form-group">
                ...
                >
                  <option value="">
                    {!formData.tipo_vehiculo ? "Seleccione un tipo de vehículo" : "Seleccione un modelo"}
                  </option>
          ...
          <div className="cvc-crear-form-actions">
            <button
              type="submit"
              className="cvc-crear-submit-button"
              disabled={loading}
            >
              {loading ? (
                <>
